...
Milk-V Pioneer Box:
\begin{itemize}
    \item CPU: SG2042 64 Core C920@1.0GHz
...
Sipeed LicheePi 4A:
\begin{itemize}
    \item CPU: TH1520, RISC-V 1.85G C910 x4
...
\begin{itemize}
    ...
    \item RAM: 8 GiB
    \item Host: 4*2.5" SAS HDD，硬 RAID-5 Guest: VirtIO SCSI Single, Write Back Cache, io\_uring
\end{itemize}
